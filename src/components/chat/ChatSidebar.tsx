  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center gap-1 bg-slate-900 border border-slate-800 border-r-0 rounded-l-xl px-2 py-3 text-slate-400 hover:text-violet-400 hover:bg-slate-850 cursor-pointer transition-all duration-200 shadow-lg"
          title="Open chat"
        >
