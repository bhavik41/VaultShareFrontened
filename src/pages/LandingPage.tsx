...
const SECURITY = [
  {
    ...
    desc: "Every request verified. No implicit trust in any request, user, or system.",
  },
  {
    color: "#fbbf24",
    glow: "rgba(251,191,36,0.18)",
    ...
    desc: "Your encryption keys never touch our servers. Complete data sovereignty.",
  },
  {
    color: "#00e5a0",
    glow: "rgba(0,229,160,0.18)",
    ...
    desc: "Latest TLS standard for all data in motion. Zero downgrade attacks.",
  },
  {
    color: "#f97316",
    ...
    desc: "Independently audited every year. Verified security controls.",
  },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex-1 py-10 pl-0 pr-40 relative z-10 flex flex-col justify-center items-end text-right">
              ...
              >
                <span
                  style={{
                    background:
                      "linear-gradient(180deg, #fff 60%, rgba(255,255,255,0.4) 100%)",
              ...
              >
                End-to-end encrypted file sharing with real-time document
                collaboration. Zero-knowledge. Zero compromises.
              </motion.p>
                ...
                {isLoggedIn ? (
                  <>
                    <motion.div
                      whileHover={{
                        scale: 1.04,
                        boxShadow: "0 8px 30px rgba(0,229,160,0.25)",
                      }}
                      whileTap={{ scale: 0.97 }}
            ...
            {/* Right — 3D scene */}
            <div
              className="flex-1 relative hidden mr-6 md:block"
              style={{ overflow: "hidden" }}
            >
              <div
                style={{ width: "120%", height: "100%", marginLeft: "-31%" }}
              >
                <SplineScene
              ...
              >
                <div
                  style={{
                    ...
                    lineHeight: 1.1,
                    background:
                      "linear-gradient(180deg, #fff 50%, rgba(255,255,255,0.5) 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                  }}
          ...
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2
              style={{
                ...
                margin: "0 auto",
                background:
                  "linear-gradient(180deg, #fff 60%, rgba(255,255,255,0.45) 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
              }}
          ...
          {FEATURES.map(({ icon, color, glow, bg, title, desc }, i) => (
            <FadeUp key={title} delay={i * 0.07}>
              <motion.div
                whileHover={{
                  y: -6,
                  boxShadow: `0 24px 48px rgba(0,0,0,0.4), 0 0 0 1px ${color}33, 0 0 24px ${glow}`,
                }}
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <FadeUp>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              >
                No switching between Slack and your files. Decisions happen
                  ...
                  {[
                    {
                      ...
                      msg: "Revenue on line 14 doesn't match Q3",
                      time: "1m ago",
                    },
                    {
                      initials: "SR",
                      color: "#8b5cf6",
                      border: "transparent",
                      msg: "You're right — formula is wrong. Fixing now?",
                      time: "1m ago",
                    },
                    {
                      initials: "JT",
                      color: "#f97316",
                      border: "transparent",
                      msg: "Lock this section. Finance-only.",
                      time: "1m ago",
                    },
                    {
                      initials: "AK",
                      color: "#1c1c1c",
                      border: "rgba(255,255,255,0.15)",
                      msg: "Agreed. Mark resolved after done.",
                      time: "1m ago",
                    },
          ...
          >
            ...
            <FadeUp delay={0.05}>
              ...
              >
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <span
                    style={{ fontSize: 15, color: "#475569", marginLeft: 4 }}
                  >
                    /mo
                  </span>
                </div>
            ...
            <FadeUp delay={0.18}>
              ...
              >
                ...
                >
                  <a
                    href="mailto:sales@vaultshare.io"
                    style={{
                      display: "block",
                      textAlign: "center",
                      padding: "12px",
          ...
          <div style={{ position: "relative" }}>
            ...
            <h2
              style={{
                ...
                marginBottom: 20,
                background:
                  "linear-gradient(180deg, #fff 50%, rgba(255,255,255,0.4) 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
              }}
            ...
            >
              Trusted by teams who protect their most sensitive documents with
              VaultShare.
            </p>
            <div
              style={{
              ...
              {isLoggedIn ? (
                <>
                  <motion.div
                    whileHover={{
                      scale: 1.04,
                      boxShadow: "0 12px 40px rgba(0,229,160,0.3)",
                    }}
                    whileTap={{ scale: 0.97 }}
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            >
              <div>
                ...
                >
                  Secure file sharing with real-time collaboration.
                  <br />
            ...
            >
              <p style={{ fontSize: 12, color: "#1f2937" }}>
                © 2025 VaultShare, Inc. All rights reserved.
              </p>
              <p style={{ fontSize: 12, color: "#1f2937" }}>
