...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#080810] text-slate-900">
      ...
      {/* Mission */}
      <section className="mx-auto max-w-5xl px-6 pb-16">
        <div className="rounded-xl border border-gray-200 bg-[#0f1020] p-8" style={{ borderLeft: "4px solid #22d3ee" }}>
          <h2 className="mb-3 text-lg font-bold text-slate-900">Our Mission</h2>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="rounded-2xl border border-gray-300 bg-[#0f1020] p-12 text-center" style={{ borderLeft: "4px solid #22d3ee" }}>
